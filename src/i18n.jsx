...
export const translations = {
  ...
  portfolio_item_ecom_desc: { es: 'Tienda online estilo Y2k completamente interactiva(version de prueba)', en: 'Modern online Y2k shop fully interactive (mock version)' },
  portfolio_item_site_desc: { es: 'Sitio web Del proyecto universitario cubesat', en: 'Website for the college project CUBESAT' },

  portfolio_item_landing_desc: { es: 'Landing Page para el proyecto NeoMagic fest, festival medieval', en: 'Landing Page for the NeoMagic fest project, medieval festival' },
